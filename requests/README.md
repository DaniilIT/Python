...
**REST** - (это не спецификация и не стандарт) это стиль веб-архитектуры, который описывает принципы взаимодействия клиента и сервера.\
...
3) Используете только строчные буквы (lowercase), в краних случаях `_`
4) Старайтесь делать короткие URL (должен буть небольшой уровень вложенности)
